...
for val in "${vals[@]}"; do
    ...
    # python -m tu.sbatch.sbatch_sweep --time 96:00:00 \
    # --proj_dir /viscam/projects/image2Blender/diffusers/examples/textual_inversion --conda_env diffusers \
    # --job "08-12-p2-black-chair-4pics-${val}-LR5e-06" --command "accelerate launch textual_inversion_phase_2.py   --pretrained_model_name_or_path='results-black_chair_textures-4pics-1000-LR5e-06'  --train_data_dir='images/black_chair_real-4pics' --save_as_full_pipeline  --learnable_property='object'   --placeholder_token='<chair-real>'   --initializer_token='chair' --existing_token='<chair-toy>'  --resolution=512   --train_batch_size=1   --gradient_accumulation_steps=4   --max_train_steps=${val}   --learning_rate=5.0e-06   --scale_lr   --lr_scheduler='constant'   --lr_warmup_steps=0  --output_dir='results-black_chair-from_textures-1000-LR5e-06-real-4pics-${val}-LR5e-06' && python inference.py --prompt 'a photo of a <chair-real>' --model_id 'results-black_chair-from_textures-1000-LR5e-06-real-4pics-${val}-LR5e-06' --output_image_name 'output_imgs/results-black_chair-from_textures-1000-LR5e-06-real-4pics-${val}-LR5e-06.png' && python inference.py --prompt 'a photo of a <chair-toy> in the style of <chair-real>' --model_id 'results-black_chair-from_textures-1000-LR5e-06-real-4pics-${val}-LR5e-06' --output_image_name 'output_imgs/results-black_chair-from_textures-1000-LR5e-06-real-4pics-${val}-LR5e-06-both.png'"  $GPU_INFO "$EXTRA_GPU_INFO"

    # python -m tu.sbatch.sbatch_sweep --time 96:00:00 \
    # --proj_dir /viscam/projects/image2Blender/diffusers/examples/textual_inversion --conda_env diffusers \
    # --job "08-12-p2-brown-chair-4pics-${val}-LR5e-06" --command "accelerate launch textual_inversion_phase_2.py   --pretrained_model_name_or_path='results-brown_chair_rendered-4pics-3000-LR5e-04'  --train_data_dir='images/brown_chair_real-4pics' --save_as_full_pipeline  --learnable_property='object'   --placeholder_token='<chair-real>'   --initializer_token='chair' --existing_token='<chair-toy>'  --resolution=512   --train_batch_size=1   --gradient_accumulation_steps=4   --max_train_steps=${val}   --learning_rate=5.0e-06   --scale_lr   --lr_scheduler='constant'   --lr_warmup_steps=0  --output_dir='results-brown_chair-from_rendered-3000-LR5e-04-real-4pics-${val}-LR5e-06' && python inference.py --prompt 'a photo of a <chair-real>' --model_id 'results-brown_chair-from_rendered-3000-LR5e-04-real-4pics-${val}-LR5e-06' --output_image_name 'output_imgs/results-brown_chair-from_rendered-3000-LR5e-04-real-4pics-${val}-LR5e-06.png' && python inference.py --prompt 'a photo of a <chair-toy> in the style of <chair-real>' --model_id 'results-brown_chair-from_rendered-3000-LR5e-04-real-4pics-${val}-LR5e-06' --output_image_name 'output_imgs/results-brown_chair-from_rendered-3000-LR5e-04-real-4pics-${val}-LR5e-06-both.png'"  $GPU_INFO "$EXTRA_GPU_INFO"
