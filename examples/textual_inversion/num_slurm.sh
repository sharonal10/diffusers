...
for val in "${vals[@]}"; do
    python -m tu.sbatch.sbatch_sweep --time 96:00:00 \
    --proj_dir /viscam/projects/image2Blender/diffusers/examples/textual_inversion --conda_env diffusers \
    --job "08-10-p3-brown-chair-table-4pics-${val}-LR5e-04" --command "accelerate launch textual_inversion_phase_3.py   --pretrained_model_name_or_path='results-brown_chair-from_rendered-500-LR5e-06-real-4pics-3000-LR5e-06'  --train_data_dir='images/brown_table_rendered-4pics' --save_as_full_pipeline  --learnable_property='object'   --placeholder_token='<table-toy>'   --initializer_token='table'  --resolution=512   --train_batch_size=1   --gradient_accumulation_steps=4   --max_train_steps=${val}   --learning_rate=5.0e-04   --scale_lr   --lr_scheduler='constant'   --lr_warmup_steps=0  --output_dir='p3-brown-table-${val}-LR5e-04-on-brown_chair-from_rendered-500-LR5e-06-real-4pics-3000-LR5e-06' && python inference.py --prompt 'a photo of a <table-toy>' --model_id 'p3-brown-table-${val}-LR5e-04-on-brown_chair-from_rendered-500-LR5e-06-real-4pics-3000-LR5e-06' --output_image_name 'output_imgs/p3-brown-table-${val}-LR5e-04-on-brown_chair-from_rendered-500-LR5e-06-real-4pics-3000-LR5e-06.png' && python inference.py --prompt 'a photo of a <table-toy> in the style of <chair-real>' --model_id 'p3-brown-table-${val}-LR5e-04-on-brown_chair-from_rendered-500-LR5e-06-real-4pics-3000-LR5e-06' --output_image_name 'output_imgs/p3-brown-table-${val}-LR5e-04-both-on-brown_chair-from_rendered-500-LR5e-06-real-4pics-3000-LR5e-06.png'"  $GPU_INFO "$EXTRA_GPU_INFO"
    # ----
