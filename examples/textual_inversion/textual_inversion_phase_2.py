...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="This is phase 2, requires the token used in phase 1 to use in the prompt during training."
    )
...
def main():
    ...
    if args.resume_from_checkpoint:
        if args.resume_from_checkpoint != "latest":
            ...
            # Get the most recent checkpoint (from pretrained_model_name_or_path, not output_dir)
